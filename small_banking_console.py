...
class Bank:
    ...
    def storePassword(self):
        ...
        if checkLength < 8:
            print("Your password must be more than eight characters and must include at least one uppercase letter, one lowercase letter, one special character, and one number.")
            self.storePassword()
        has_uppercase = False
        has_lowercase = False
        has_number = False
        ...
        if not (has_uppercase and has_lowercase and has_number and has_special):
            print("Your password must include at least one uppercase letter, one lowercase letter, one special character, and one number.")
            self.storePassword()
